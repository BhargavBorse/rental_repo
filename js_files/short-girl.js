...
dbRef.child('item').child('Girls').on('value',function(item_details_snapshot){
    ...
    {
        // if(uid == 'sherwani'){}
        itemRef.child('Girls').child(women_keys[i]).on('value',function(item_deep_details_snapshot){
            ...
            // if(item_deep_details.item_subcategory == 'Sherwani'){
                ...
                document.getElementsByClassName('girl-sherwani')[0].appendChild(div_sub0);
