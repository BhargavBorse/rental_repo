            ...
            for(var i=0;i<men_keys.length;i++)
            {
                ...
                itemRef.child('Men').child(men_keys[i]).on('value',function(item_deep_details_snapshot){
                    ...
                    if(item_deep_details.item_subcategory == 'Sherwani'){
                        ...
                        document.getElementsByClassName('men-sherwani')[0].appendChild(div_sub0);
        ...
        dbRef.child('item').child('Men').on('value',function(item_details_snapshot){
            ...
            for(var i=0;i<men_keys.length;i++)
            {
                ...
                itemRef.child('Men').child(men_keys[i]).on('value',function(item_deep_details_snapshot){
                    ...
                    if(item_deep_details.item_subcategory == 'Kurta-pyjama'){
                        // alert(item_deep_details.recommended);
        ...
        dbRef.child('item').child('Men').on('value',function(item_details_snapshot){
            ...
            for(var i=0;i<men_keys.length;i++)
            {
                ...
                itemRef.child('Men').child(men_keys[i]).on('value',function(item_deep_details_snapshot){
                    ...
                    if(item_deep_details.item_subcategory == 'Blazer'){
                        // alert(item_deep_details.recommended);
        ...
        dbRef.child('item').child('Men').on('value',function(item_details_snapshot){
            ...
            for(var i=0;i<men_keys.length;i++)
            {
                ...
                itemRef.child('Men').child(men_keys[i]).on('value',function(item_deep_details_snapshot){
                    ...
                    if(item_deep_details.item_subcategory == 'Suit'){
                        // alert(item_deep_details.recommended);
        ...
        dbRef.child('item').child('Men').on('value',function(item_details_snapshot){
            ...
            for(var i=0;i<men_keys.length;i++)
            {
                ...
                itemRef.child('Men').child(men_keys[i]).on('value',function(item_deep_details_snapshot){
                    ...
                    if(item_deep_details.item_subcategory == 'Men-Accessories'){
                        // alert(item_deep_details.recommended);
        ...
        dbRef.child('item').child('Women').on('value',function(item_details_snapshot){
            ...
            for(var i=0;i<women_keys.length;i++)
            {
                ...
                itemRef.child('Women').child(women_keys[i]).on('value',function(item_deep_details_snapshot){
                    ...
                    if(item_deep_details.item_subcategory == 'Anarkali'){
                        // alert(item_deep_details.recommended);
                        ...
                        // //Appending div-class=owl-item to div-class=owl-stage
                        document.getElementsByClassName('women-anarkali')[0].appendChild(div_sub0);
        ...
        dbRef.child('item').child('Women').on('value',function(item_details_snapshot){
            ...
            for(var i=0;i<women_keys.length;i++)
            {
                ...
                itemRef.child('Women').child(women_keys[i]).on('value',function(item_deep_details_snapshot){
                    ...
                    if(item_deep_details.item_subcategory == 'Lehenga'){
                        // alert(item_deep_details.recommended);
        ...
        dbRef.child('item').child('Women').on('value',function(item_details_snapshot){
            ...
            for(var i=0;i<women_keys.length;i++)
            {
                ...
                itemRef.child('Women').child(women_keys[i]).on('value',function(item_deep_details_snapshot){
                    ...
                    if(item_deep_details.item_subcategory == 'Gown'){
                        // alert(item_deep_details.recommended);
        ...
        dbRef.child('item').child('Women').on('value',function(item_details_snapshot){
            ...
            for(var i=0;i<women_keys.length;i++)
            {
                ...
                itemRef.child('Women').child(women_keys[i]).on('value',function(item_deep_details_snapshot){
                    ...
                    if(item_deep_details.item_subcategory == 'Sarees'){
                        // alert(item_deep_details.recommended);
        ...
        dbRef.child('item').child('Women').on('value',function(item_details_snapshot){
            ...
            for(var i=0;i<women_keys.length;i++)
            {
                ...
                itemRef.child('Women').child(women_keys[i]).on('value',function(item_deep_details_snapshot){
                    ...
                    if(item_deep_details.item_subcategory == 'Top-skirts'){
                        // alert(item_deep_details.recommended);
        ...
        dbRef.child('item').child('Women').on('value',function(item_details_snapshot){
            ...
            for(var i=0;i<women_keys.length;i++)
            {
                ...
                itemRef.child('Women').child(women_keys[i]).on('value',function(item_deep_details_snapshot){
                    ...
                    if(item_deep_details.item_subcategory == 'Women-Accessories'){
                        // alert(item_deep_details.recommended);
        ...
        dbRef.child('item').child('Boy').on('value',function(item_details_snapshot){
            ...
            for(var i=0;i<boy_keys.length;i++)
            {
                ...
                itemRef.child('Boy').child(boy_keys[i]).on('value',function(item_deep_details_snapshot){
                    ...
                    if(item_deep_details.item_subcategory == 'Boy'){
                        // alert(item_deep_details.recommended);
                        ...
                        // //Appending div-class=owl-item to div-class=owl-stage
                        document.getElementsByClassName('kids-cloth')[0].appendChild(div_sub0);
        ...
        dbRef.child('item').child('Girls').on('value',function(item_details_snapshot){
            ...
            for(var i=0;i<girl_keys.length;i++)
            {
                ...
                itemRef.child('Girls').child(girl_keys[i]).on('value',function(item_deep_details_snapshot){
                    ...
                    if(item_deep_details.item_subcategory == 'Girls'){
                        // alert(item_deep_details.recommended);
