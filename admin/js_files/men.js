...
firebase.auth().onAuthStateChanged(function(user) {
    ...
    databaseRef.child('Men').child(id).on('value',function(update_snapshot){
        ...
        document.getElementById('image_x').value = update_snapshot.child('optional_image').val();            
    ...
    databaseRef.child('Men').child(id).child('deals_of_the_day').on('value',function(update_checkbox_snapshot){
    ...
    firebase.auth().onAuthStateChanged(function(user) {
        ...
        databaseRef.child('Men').child(id).child('recommended').on('value',function(update_checkbox_snapshot_rec){
    ...
    document.getElementById('btn_insertname').onclick = function(){
        ...
        function(snapshot){
            ...
            uploadTask.snapshot.ref.getDownloadURL().then(function(downloadURL){
                databaseRef.child('Men').child(id).update({
                    item_name : item_name,
    ...
    document.getElementById('btn_inactive').onclick = function(){
        ...
        databaseRef.child('Men').child(id).on('value',function(order_snapshot){
    ...
    databaseRef.child('inactive').push({
