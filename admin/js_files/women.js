...
//Women
 ...
 databaseRef_women.child('item').child('Women').child(id).on('value',function(update_snapshot){
...
databaseRef_women.child('item').child('Women').child(id).child('deals_of_the_day').on('value',function(update_checkbox_snapshot){
...
databaseRef_women.child('item').child('Women').child(id).child('recommended').on('value',function(update_checkbox_snapshot_rec){
