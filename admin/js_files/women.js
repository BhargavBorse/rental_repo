...
//Women
 ...
 databaseRef_women.child('Women').child(id).on('value',function(update_snapshot_women){
        
    // alert('fetching womens data');
    document.getElementById('item_name').value = update_snapshot_women.child('item_name').val();
    document.getElementById('item_description').value = update_snapshot_women.child('item_description').val();
    document.getElementById('item_subcategory').value = update_snapshot_women.child('item_subcategory').val();
...
databaseRef_women.child('Women').child(id).child('deals_of_the_day').on('value',function(update_checkbox_snapshot){
...
databaseRef_women.child('Women').child(id).child('recommended').on('value',function(update_checkbox_snapshot_rec){
