var tableRef = document.getElementById('inactive_table').getElementsByTagName('tbody')[0];

firebase.database().ref().child('item').child('inactive').on('child_added',function(View_item){
    ...
    var item_update_text = document.createTextNode('More Info');
    ...
    item_update.href = "item_activate.html?id="+id+ "&uid="+user_id;
