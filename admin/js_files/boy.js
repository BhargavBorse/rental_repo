...
//Women
 ...
 databaseRef_women.child('item').child('Boy').child(id).on('value',function(update_snapshot){
...
databaseRef_women.child('item').child('Boy').child(id).child('deals_of_the_day').on('value',function(update_checkbox_snapshot){
...
databaseRef_women.child('item').child('Boy').child(id).child('recommended').on('value',function(update_checkbox_snapshot_rec){
